<div>
    <div class="flex flex-col gap-2">
        <p class="text-2xl text-black">Sign in</p>
        <p class="text-lg text-black">Sign in to get access the features of “WeatherPREDIK”</p>
    </div>
    <div class="flex flex-col gap-10 mt-10">
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="relative">
                <input wire:model="password" id="hs-toggle-password" type="password"
                    class="py-2.5 sm:py-3 px-4 block w-full border border-black rounded-lg
                 sm:text-sm focus:border-blue-500 disabled:pointer-events-none
                  bg-white  text-[#000000CC] placeholder-[#000000B3]
                   focus:ring-neutral-600"
        ...
        <div>
            <button wire:click.prevent="signIn" type="button"
    ...
    <div class="text-black mt-4">
        ...
        <a class="text-[#00000099] cursor-default" wire:click.prevent="navigateToSignUp">Sign up</a>
    </div>
</div>
